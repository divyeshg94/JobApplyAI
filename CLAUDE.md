...
- **Feature branch + PR into `main`**, not direct commits to `main` — established from milestone 7 onward (PR #1). `main` itself still only ever gets fast-forward merges from a reviewed branch.
